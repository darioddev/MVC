...
<body>
    ...
    <div class="home">
        ...
        <p class="text">SECCION DE DISCOS</p>

        <p class="mostrarParrafo">
            <?php echo count($discosActivos) ?> activos
        </p>
        <p class="mostrarParrafo">
            <?php echo count($discosInactivos) ?> activos
        </p>
        ...
        <div class="pagination">
            <ul>
                ...
                for ($i = 1; $i <= $totalPaginas; $i++) { ?>
                    <li><a href="<?php echo $ruta . "Discos/" . $i ?>">
                            <?php echo $i ?>
                        </a></li>
                <?php } ?>
        ...
        <div class="btnContent">
            <a href="<?php echo $redirect . 'Anadir/Disco' ?>" class="btn btn-primary">Añadir </a>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                foreach ($discos as $disco) {
                    ...
                    <tr>
                        <?php
                        foreach ($disco as $propiedad => $value) {
                            switch (strtolower($propiedad)) {
                                ...
                                case "imagen":
                                    ?>
                                    <td><img src="<?php echo $URL . "Discos" . "/" . $value ?>" alt="" width="300px" height="500px">
                                    </td>
                                    <?php
                                    break;
                                case "anio":
